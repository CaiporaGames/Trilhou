...
namespace Fernando
{
    //Para funcionar este script tem que estar em um gameobject no canvas.
    //Este mesmo gameobject tem que ter um collider,
    //este collider pode estar como trigger ou não.
    //Na hieraquia tem que ter um EventSystem component.

    public class Baloes : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
